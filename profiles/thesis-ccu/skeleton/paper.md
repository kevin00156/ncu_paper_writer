...
header-includes:
  - |
    ...
    % === 圖表標題置中、名稱中文化（CCU 風格：圖N. 標題 / 表N. 標題）===
    ...
    % === 章節編號（CCU 風格：第一章 中文數字；節以下用阿拉伯） ===
    \renewcommand{\thesection}{\zhnumber{\value{section}}}
    \renewcommand{\thesubsection}{\arabic{section}.\arabic{subsection}}
    \renewcommand{\thesubsubsection}{\arabic{section}.\arabic{subsection}.\arabic{subsubsection}}

    % === 章標題格式：置中、加粗、加上「第X章」前綴（中文數字）===
    \titleformat{\section}
      {\centering\Large\bfseries}
      {第\zhnumber{\value{section}}章}{1em}{}
